...
export function EarlyAccess() {
  ...
  // ✅ Formspree hook (replace with your Formspree ID)
          ...
          <div className="max-w-2xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-xl text-[#8d6e63]">
                Welcome to the inner circle, {formData.name || "VIP"}! You'll be
                the first to know when the magic begins!
              </p>
            </div>
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-10 left-10 text-[#ff5722] text-6xl animate-pulse opacity-20">
          🔮
        </div>
        <div className="absolute top-20 right-20 text-[#e91e63] text-4xl animate-bounce opacity-20">
          ✨
        </div>
        <div className="absolute bottom-20 left-20 text-[#ff5722] text-5xl animate-pulse opacity-20">
          🎭
        </div>
        <div className="absolute bottom-10 right-10 text-[#e91e63] text-6xl animate-bounce opacity-20">
          💫
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-[#8d6e63] mb-8 max-w-2xl mx-auto leading-relaxed">
              The most exclusive dating experience is almost here. Where stunning
              ladies meet generous gentlemen, and every connection is worth the
              wait. 🎩💎
            </p>
          </div>
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-2xl max-w-2xl mx-auto mb-12 overflow-hidden">
            <div className="bg-gradient-to-r from-[#ff5722] to-[#e91e63] p-6 text-white">
              ...
              <p className="text-white/90 text-sm">
                Join the exclusive circle of early adopters
              </p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <Label htmlFor="name" className="flex items-center gap-2">
                    <User className="h-4 w-4 text-[#ff5722]" /> Full Name
                  </Label>
                  <Input
                    id="name"
                    name="name"
                ...
                <div>
                  <Label htmlFor="email" className="flex items-center gap-2">
                    <Mail className="h-4 w-4 text-[#ff5722]" /> Email
                  </Label>
                  <Input
                    id="email"
                    name="email"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <Label htmlFor="city" className="flex items-center gap-2">
                      <MapPin className="h-4 w-4 text-[#ff5722]" /> City
                    </Label>
                    <Input
                      id="city"
                      name="city"
                ...
                {getOnboardingTip() && (
                  <div
                    className={`bg-gradient-to-r ${getOnboardingTip()?.color} border-2 rounded-xl p-4`}
                  >
                    <p>{getOnboardingTip()?.icon} {getOnboardingTip()?.text}</p>
                  </div>
                )}
          ...
          <div className="mt-8 space-y-4">
            <p className="text-sm text-[#8d6e63] flex items-center justify-center gap-2">
              <Users className="h-4 w-4" /> Join over 5,000+ people waiting for
              launch day
            </p>
            <div className="text-center">
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#ff5722]/10 to-[#e91e63]/10 border border-[#ff5722]/20 rounded-full px-6 py-3">
                🎃 <p className="text-[#ff5722] font-bold">Launch Date: October 31st</p> 🎃
              </div>
            </div>
          </div>
        </div>
